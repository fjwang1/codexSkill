...
Phase 5: english-article-chinese-single-host-video -> 单人口播解释视频 + Bilibili upload and final submit
```
...
2. `/Users/wangfangjia/.codex/skills/english-article-chinese-single-host-video/SKILL.md`
   - 负责从本地英文文章文件生成完整中文单人口播解释视频，并在用户真实 Chrome 中自动提交 B 站投稿。
...
Gate 4 Video:
  ...
  Bilibili metadata and upload/submission report recorded when present
```
...
- `bilibili_upload_draft_report.json` 路径和投稿提交状态。
